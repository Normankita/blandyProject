        ...
        <div>Me
            ...
            <div class="bg-gray-100 h-screen flex flex-col max-w-lg mx-auto">
                <div class="bg-yellow-500 p-4 text-white flex justify-between items-center">
                    <button id="login" class="hover:bg-yellow-400 rounded-md p-1">
                    ...
                    <div class="relative inline-block text-left">
                        <button id="setting" class="hover:bg-yellow-400 rounded-md p-1">
                ...
                <div class="flex-1 overflow-y-auto p-4">
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="flex justify-end">
                            <div class="bg-yellow-200 text-black p-2 rounded-lg max-w-xs">
                ...
                <div class="bg-white p-4 flex items-center">
                    ...
                    <button class="bg-yellow-500 text-white rounded-full p-2 ml-2 hover:bg-yellow-600 focus:outline-none">
