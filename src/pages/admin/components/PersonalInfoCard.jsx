...
const socialIcons = [
  { icon: FaFacebookF, hoverClass: "hover:text-yellow-500" },
  ...
  return (
    <div className="  bg-slate-50 dark:bg-slate-900 text-gray-800 dark:text-white p-6 rounded-2xl shadow-lg max-w-4xl mx-auto md:max-w-2xl sm:max-w-full">
      ...
      <div className="flex justify-end mt-6">
        <button onClick={() => userProfile ? navigate("/register") : navigate("/")} className={clsx("bg-yellow-600", "hover:bg-yellow-500", "text-white", "px-4", "py-2", "rounded-lg")}>
