...
export const UserForm = ({ error, handleSubmit, handleChange, formData, setFormData, datepickerRef, auth, submitting }) => {
        ...
        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
          ...
          "stripClasses": "hs-strong-password:opacity-100 hs-strong-password-accepted:bg-teal-500 h-2 flex-auto rounded-full bg-yellow-500 opacity-50 mx-1"
            ...
            <div>
              <input
                type="submit"
                value={auth ? "create user Profile" : "Create your profile"}
